...
void sampleFSRs() {
  ...
  for (int i = 0; i < 12; i++) {
    ...
    if (intensity > ONTHRESHOLD) {
      if (noteOn[i] == false) {
        MIDI.sendNoteOn(36 + i, 127, MIDI_CHANNEL_OMNI);
        noteOn[i] = true;
        duration[i] = millis();
      }
    ...
    // If the note was originally on
      ...
      MIDI.sendNoteOff(36 + i, 0, MIDI_CHANNEL_OMNI);
  ...
  for (int i = 0; i < 12; i++) {
    ...
    if (intensity > ONTHRESHOLD) {
      if (noteOn[12 + i] == false) {
        MIDI.sendNoteOn(48 + i, 127, MIDI_CHANNEL_OMNI);
        noteOn[12 + i] = true;
    ...
    // If the note was originally on
      ...
      MIDI.sendNoteOff(48 + i, 0, MIDI_CHANNEL_OMNI);
  ...
  for (int i = 0; i < 12; i++) {
    ...
    if (intensity > ONTHRESHOLD) {
      if (noteOn[36 + i] == false) {
        MIDI.sendNoteOn(72 + i, 127, MIDI_CHANNEL_OMNI);
        noteOn[36 + i] = true;
    ...
    // If the note was originally on
      ...
      MIDI.sendNoteOff(72 + i, 0, MIDI_CHANNEL_OMNI);
  ...
  for (int i = 0; i < 12; i++) {
    ...
    if (intensity > ONTHRESHOLD) {
      if (noteOn[24 + i] == false) {
        MIDI.sendNoteOn(60 + i, 127, MIDI_CHANNEL_OMNI);
        noteOn[24 + i] = true;
    ...
    // If the note was originally on
      ...
      MIDI.sendNoteOff(60 + i, 0, MIDI_CHANNEL_OMNI);
