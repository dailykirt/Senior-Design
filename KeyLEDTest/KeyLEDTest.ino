...
void setKey(int key) {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    setColor(36 + 12 * (4 - i) + tonic, RED);
    setColor(36 + 12 * i + supertonic, BLUE);
    setColor(36 + 12 * (4 - i) + mediant, BLUE);
    setColor(36 + 12 * i + subdominant, YELLOW);
    setColor(36 + 12 * (4 - i) + dominant, YELLOW);
    setColor(36 + 12 * i + submediant, BLUE);
    setColor(36 + 12 * (4 - i) + leadingTone, GREEN);
  }
}
...
////Adafruit_MCP23017 MCP7;
////
////// Digital pins in lieu of port expander
////const int PINS[16] = {36, 38, 40, 42, 44, 46, 48, 50, 51, 49, 47, 45, 43, 41, 39, 37};
////
////int keyColors[48];
////const int EXPANDERSWITCH = 11;
////
...
////
////void setCMajor() {
////  setColor(NOTE_C2, RED);
////  setColor(NOTE_C3, RED);
////  setColor(NOTE_C4, RED);
////  setColor(NOTE_C5, RED);
////  setColor(NOTE_D2, BLUE);
////  setColor(NOTE_D3, BLUE);
////  setColor(NOTE_D4, BLUE);
////  setColor(NOTE_D5, BLUE);
////  setColor(NOTE_E2, BLUE);
////  setColor(NOTE_E3, BLUE);
////  setColor(NOTE_E4, BLUE);
////  setColor(NOTE_E5, BLUE);
////  setColor(NOTE_F2, YELLOW);
////  setColor(NOTE_F3, YELLOW);
////  setColor(NOTE_F4, YELLOW);
////  setColor(NOTE_F5, YELLOW);
////  setColor(NOTE_G2, YELLOW);
////  setColor(NOTE_G3, YELLOW);
////  setColor(NOTE_G4, YELLOW);
////  setColor(NOTE_G5, YELLOW);
////  setColor(NOTE_A2, BLUE);
////  setColor(NOTE_A3, BLUE);
////  setColor(NOTE_A4, BLUE);
////  setColor(NOTE_A5, BLUE);
////  setColor(NOTE_B2, GREEN);
////  setColor(NOTE_B3, GREEN);
////  setColor(NOTE_B4, GREEN);
////  setColor(NOTE_B5, GREEN);
////}
////
////void setKey(int key) {
////  int tonic = key % 12;
...
////    keyColors[12 * i + submediant] = BLUE;
////    keyColors[12 * i + leadingTone] = GREEN;
////    setColor(36 + 12 * i + tonic, RED);
////    setColor(36 + 12 * i + supertonic, BLUE);
////    setColor(36 + 12 * i + mediant, BLUE);
////    setColor(36 + 12 * i + subdominant, YELLOW);
////    setColor(36 + 12 * i + dominant, YELLOW);
////    setColor(36 + 12 * i + submediant, BLUE);
////    setColor(36 + 12 * i + leadingTone, GREEN);
////  }
////}
//
//
